...
sv_pipeline = pipeline(
    ...
    model='model/speech_eres2net_large_sv_zh-cn_3dspeaker_16k',
...
model_vad = AutoModel(
    model="model/speech_fsmn_vad_zh-cn-16k-common-pytorch",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', type=int, default=5001, help='Port number to run the FastAPI app on.')
